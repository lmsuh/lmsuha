                            ...
                            <div class="widget widget-table action-table">
                                <div class="widget-header"> <i class="icon-list-alt"></i>
                                    ...
                                    <div class="pull-right" style="margin-right: 10px;">
                                        <a href="#myModal" role="button" class="btn btn-success" data-toggle="modal">Buat Kelas LMS</a>
                                    ...
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $kl->kode_mk; ?> </td>
                                                <td> <?php echo ucwords(strtolower($kl->nm_mk)); ?> </td>
                                                <td class="td-actions">
                                                    <?php
                                                        //$this->session->set_flashdata('idMk', $kl->id_mk);
                                                        //$this->session->mark_as_temp('item', 300);
                                                        echo anchor(
                                                            'dosen/dmk/'.$kl->id_mk.'/'.$kl->id_kelas, 
