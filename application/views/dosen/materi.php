                            ...
                            <div class="widget-table action-table">
                                <div class="widget-header"> <i class="icon-list-alt"></i>
                                    ...
                                    <div class="pull-right" style="margin-right: 10px;">
                                        <a href="#myModal" role="button" class="btn btn-success" data-toggle="modal">Tambah Materi</a>
                                    </div>
                                </div>
                                <!-- /widget-header -->
                                <div class="widget-content">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                            <tr>
                                                <td> <?php echo ucwords(strtolower($mtr->nm_materi)); ?> </td>
                                                <td> <?php echo $mtr->desc; ?> </td>
                                                <td class="td-actions">
